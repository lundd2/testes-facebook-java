...
public class BasePage {
		...
		public void selecionarComboPrime(String radical, String valor) {
			clicarRadio(By.xpath("//*[@id='"+radical+"_a']/../..//span"));
			clicarRadio(By.xpath("//*[@id='"+radical+"_a']//li[.='"+valor+"']"));
		}
		/*************** Botão ************/
		...
		public String obterTextos(String id) {
			//return getDriver().findElement(By.id(id)).getText();
		...
		public void clicarBotaoTabela(String colunaBusca, String valor, String colunaBotao, String Linhas) {
